  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        ...
        <div className='grid lg:grid-cols-2 gap-8 justify-items-center items-center'>
          {/* left */}
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full flex justify-center items-center lg:flex-col'>
              ...
              <div>
                <h2 className='py-8 text-center'>Divyanshu Gangwar</h2>
              </div>
              <div>
